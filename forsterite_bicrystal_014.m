...
p014=symmetrise(Miller(0,1,4,cs,'hkl'),'antipodal');% For Crystal 1
p014r=orib*p014;% For Crystal 2
% Rotate both into required position
p014a=ori*p014;
p014r=ori*p014r;
% Define the shear Directions
sd=Miller(0,4,-1,cs,'uvw');
sda=ori*sd
...
h5=plot(p014a,'upper','Marker','s','MarkerFaceColor',[0 0.4470 0.7410],'label',...
    ['\{',sprintf('%0.0f%0.0f%0.0f',p014.h(1),p014.k(1),p014.l(1)),'\}'], ...
    'DisplayName',['\{',sprintf('%0.0f%0.0f%0.0f',p014.h(1),p014.k(1),p014.l(1)),'\} Crystal 1']);
...
h6=plot(p014r,'upper','Marker','s','MarkerFaceColor',[0.6350 0.0780 0.1840],'label',...
    ['\{',sprintf('%0.0f%0.0f%0.0f',p014.h(1),p014.k(1),p014.l(1)),'\}'],...
    'textAboveMarker','DisplayName',['\{',sprintf('%0.0f%0.0f%0.0f',p014.h(1),p014.k(1),p014.l(1)),'\} Crystal 2']);
...
h7=plot(sda,'upper','antipodal','Marker','x','MarkerEdgeColor',...
    [0.9290 0.6940 0.1250],'LineWidth',2,'label','[04\bar{1}]','textAboveMarker', ...
