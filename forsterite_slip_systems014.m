...
SF_100(1)=SchmidFactor(ss1(ind1),v041);
SF_010(1)=SchmidFactor(ss1(ind1),v100);
SF_100r(1)=SchmidFactor(ss1(ind2),v041r);
...
phi2(1)=angle(ss1.b(ind1),d041,'nosymmetry');
...
SF_100(2)=SchmidFactor(ss2(ind1),v041);
SF_010(2)=SchmidFactor(ss2(ind1),v100);
SF_100r(2)=SchmidFactor(ss2(ind2),v041r);
...
phi2(2)=angle(ss2.b(ind1),d041,'nosymmetry');
...
SF_100(3)=SchmidFactor(ss3(ind1),v041);
SF_010(3)=SchmidFactor(ss3(ind1),v100);
SF_100r(3)=SchmidFactor(ss3(ind2),v041r);
SF_010r(3)=SchmidFactor(ss3(ind2),v100r);
% angle between Brrger's vector and plane normal
phi1(3)=angle(ss3.b(ind1),d100);
phi2(3)=angle(ss3.b(ind1),d041);
...
SF_100(4)=SchmidFactor(ss4(ind1),v041);
SF_010(4)=SchmidFactor(ss4(ind1),v100);
SF_100r(4)=SchmidFactor(ss4(ind2),v041r);
SF_010r(4)=SchmidFactor(ss4(ind2),v100r);
% angle between Brrger's vector and plane normal
phi1(4)=angle(ss4.b(ind1),d100);
phi2(4)=angle(ss4.b(ind1),d041);
...
SF=ss5.SchmidFactor(v041);
SF_100(5)=SF(I);
SF=ss5.SchmidFactor(v100);
SF_010(5)=SF(I);
SF=ss5r.SchmidFactor(v041r);
SF_100r(5)=SF(I);
...
SF_100(6)=SchmidFactor(ss6(ind1),v041);
SF_010(6)=SchmidFactor(ss6(ind1),v100);
SF_100r(6)=SchmidFactor(ss6(ind2),v041r);
SF_010r(6)=SchmidFactor(ss6(ind2),v100r);
% angle between Brrger's vector and plane normal
phi1(6)=angle(ss6.b(ind1),d100);
phi2(6)=angle(ss6.b(ind1),d041);
...
SF_100(7)=SchmidFactor(ss7(ind1),v041);
SF_010(7)=SchmidFactor(ss7(ind1),v100);
SF_100r(7)=SchmidFactor(ss7(ind2),v041r);
SF_010r(7)=SchmidFactor(ss7(ind2),v100r);
% angle between Brrger's vector and plane normal
phi1(7)=angle(ss7.b(ind1),d100);
phi2(7)=angle(ss7.b(ind1),d041);





T014=table(sstxt',m_prime',Ass',phi1'/degree,phi2'/degree,SF_100',SF_100r',SF_010',SF_010r');
T014.Properties.VariableNames = {'Slip System','mPrime','Angle',...
    'phi_100','phi_041','SF [100]','SF [100] Rotated','SF [0 4 -1]','SF [0 4 -1] Rotated'};
T014
writetable(T014,'T014_new.xls')
m014=symmetrise(m014);
m014r=ori*m014;
%% Plot figure
f=figure(1);
clf
...
h5=plot(m014,'upper','Marker','s','MarkerFaceColor',[0 0.4470 0.7410],'label',...
    ['\{',sprintf('%0.0f%0.0f%0.0f',m014.h(1),m014.k(1),m014.l(1)),'\}'], ...
...
h6=plot(m014r,'upper','Marker','s','MarkerFaceColor',[0.6350 0.0780 0.1840],'label',...
    ['\{',sprintf('%0.0f%0.0f%0.0f',m014.h(1),m014.k(1),m014.l(1)),'\}'],...
...
h9=plot(v041,'upper','Marker','+','MarkerEdgeColor',[0.4660 0.6740 0.1880],'LineWidth',2,...
